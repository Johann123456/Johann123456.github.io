...
- [leetcode题目](#leetcode题目)
  ...
  - [1.两数之和](#1两数之和)
  - [53.最大子序和](#53最大子序和)
  - [21.合并有序链表，合并K个有序链表](#21合并有序链表合并k个有序链表)
  - [46.全排列](#46全排列)
  - [47.全排列II](#47全排列ii)
  - [54.螺旋矩阵](#54螺旋矩阵)
  ...
  - [153.搜索旋转排序数组最小值I/II](#153搜索旋转排序数组最小值iii)
  - [322.零钱兑换](#322零钱兑换)
  - [165.比较版本号](#165比较版本号)
  - [105.前序中序恢复二叉树](#105前序中序恢复二叉树)
  - [链表快排](#链表快排)
  - [32.最长有效括号](#32最长有效括号)
  - [718.最长公共子数组](#718最长公共子数组)
  - [1143.最长公共子序列](#1143最长公共子序列)
  - [151.翻转字符串里的单词](#151翻转字符串里的单词)
  - [19.删除链表倒数第N个节点](#19删除链表倒数第n个节点)
  - [470.rand7()生成rand10()](#470rand7生成rand10)
  - [169.多数元素](#169多数元素)
  - [208.Trie树](#208trie树)
  - [三球排序](#三球排序)
  - [55.跳跃游戏](#55跳跃游戏)
  - [39.组合总和I/II](#39组合总和iii)
  - [46.全排列I/II](#46全排列iii)
  - [138.复制带随机指针的链表](#138复制带随机指针的链表)
  - [135.分发糖果](#135分发糖果)
  - [找到比左边元素都大比右边元素都小的下标](#找到比左边元素都大比右边元素都小的下标)
  - [71.简化路径](#71简化路径)
  - [98.验证二叉搜索树](#98验证二叉搜索树)
  - [230.BST中的第k小元素](#230bst中的第k小元素)
  - [83.删除排序链表中的重复元素I/II](#83删除排序链表中的重复元素iii)
  - [26.删除有序数组中重复项I/II](#26删除有序数组中重复项iii)
